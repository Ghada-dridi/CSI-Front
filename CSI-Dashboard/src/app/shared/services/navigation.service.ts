...
export class NavigationService {
  iconMenu: IMenuItem[] = [
	...
	{ name: 'Entretiens & Recrutement', state: 'entretienTable/tableEntretien' },
        ...
        { name: 'AddBackOfficeRessources', state: 'add-backoffice-resource/add-backOffice-crud'},
        { name: 'AddExternalRessources', state: 'add-external-resource/add-external-crud' },
