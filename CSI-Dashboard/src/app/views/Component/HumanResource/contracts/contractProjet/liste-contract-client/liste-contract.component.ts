...
export class ListeContractComponent implements OnInit {
  ...
  getDisplayedColumns() {
    return ['titleContract','dateContract', 'lieuContract','contractType','contractStatus','actions'];
  }
...
/****************************************  get ColorStatus ********************************************/
  ...
  redirectToUpdateClientContract(data:any) {
    this.router.navigate(["/contractClient/update-client-contract"], { state: { row: data } });
  }
