...
import { CompanyStatus, Currency, LegalStatus, PaymentCondition, PaymentMode, WorkField } from 'app/shared/models/Partner';
...
export class PartnerStepperComponent implements OnInit {
  ...
  selectedEmployee= {firstName :'',ref:'string', id:null};
  selectedPartner= {id:null, name:'', currency:''};
  submitted = false;
  visible = true;
  selectable = true;
  removable = true;
  ...
  ngOnInit(): void {
    ...
    this.complInfoForm = this.fb.group({
      ...
      majorShareHolder: new UntypedFormControl('', [Validators.required]),
